...
export default function Footer() {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center w-full px-6 py-12 max-w-5xl mx-auto border-t border-outline-variant/10">
      <div className="text-[10px] uppercase tracking-[0.3em] text-on-surface-variant/20 font-mono mb-4 md:mb-0">
        {copyright}
      </div>
      <div className="font-mono text-[10px] text-accent/40 tracking-wider">
        {tagline}
      </div>
    </footer>
  );
